...
public class MqttStreamingDbContext(DbContextOptions<MqttStreamingDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SensorData>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .HasColumnName("id") // 👈 burası kritik
         ...
         modelBuilder.Entity<Workorder>(entity =>
        {
            ...
            entity.Property(e => e.CurrentScodeValue)
                .HasColumnName("CurrentScodeValue");
        });
