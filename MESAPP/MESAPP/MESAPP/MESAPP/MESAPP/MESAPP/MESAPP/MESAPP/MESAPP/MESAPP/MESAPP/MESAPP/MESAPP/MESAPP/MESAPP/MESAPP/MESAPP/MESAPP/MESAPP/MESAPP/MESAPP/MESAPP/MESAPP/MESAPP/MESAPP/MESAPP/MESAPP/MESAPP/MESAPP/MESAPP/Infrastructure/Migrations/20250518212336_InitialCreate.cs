        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SensorValue = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_workorder_performance_log_workstation_WorkstationId",
                        column: x => x.WorkstationId,
                        principalSchema: "mes_db",
                        principalTable: "workstation",
                        principalColumn: "WorkstationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_workorder_state_log", x => x.Id);
                    table.ForeignKey(
                        name: "FK_workorder_state_log_workorder_WorkorderId",
                        column: x => x.WorkorderId,
                        principalSchema: "mes_db",
                        principalTable: "workorder",
                        principalColumn: "WorkorderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_workorder_state_log_workstation_WorkstationId",
                        column: x => x.WorkstationId,
                        principalSchema: "mes_db",
                        principalTable: "workstation",
                        principalColumn: "WorkstationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_workorder_state_log_WorkorderId",
                schema: "mes_db",
